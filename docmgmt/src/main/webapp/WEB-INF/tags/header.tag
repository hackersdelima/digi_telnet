									...
									<ul>
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="${pageContext.request.contextPath }/resources/assets/images/!sample-user.jpg" alt="Joseph Doe Junior" class="img-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="${pageContext.request.contextPath }/resources/assets/images/!sample-user.jpg" alt="Joseph Junior" class="img-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="${pageContext.request.contextPath }/resources/assets/images/!sample-user.jpg" alt="Joe Junior" class="img-circle" />
												</figure>
